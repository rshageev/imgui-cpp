...
namespace ImGui
{
    ...
    IMGUI_API void          DebugNodeWindowsList(std::vector<ImGuiWindow*>& windows, const char* label);
    IMGUI_API void          DebugNodeWindowsListByBeginStackParent(std::span<ImGuiWindow*> windows, ImGuiWindow* parent_in_begin_stack);
